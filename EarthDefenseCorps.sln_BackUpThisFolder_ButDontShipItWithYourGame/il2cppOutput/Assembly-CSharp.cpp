...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerController_Parrying_m959AFA65BFB00BA5330EA035FD47857D07BEEA18 (PlayerController_t7E8D7042FA2D0DFEC54A1FCDF395161D88DAAE95* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_1 = __this->___anime_14;
		NullCheck(L_1);
		Animator_ResetTrigger_m8DCA67D5A6B56702E3FAD4E18243E194B71297CC(L_1, _stringLiteral10426521D36EB2943898BCFD2D2A17D3316B1FC5, NULL);
		// anime.SetTrigger("doParrying");
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_2 = __this->___anime_14;
		NullCheck(L_2);
		Animator_SetTrigger_mC9CD54D627C8843EF6E159E167449D216EF6EB30(L_2, _stringLiteral7FA3ED0A463C67F2F504655F521F07412E287C2C, NULL);
		// if (isJump)
		bool L_3 = __this->___isJump_8;
		if (!L_3)
		{
			goto IL_0063;
		}
	...
	{
		// parentRigid.velocity = Vector2.zero;
		Rigidbody2D_tBEBE9523CF4448544085AF46BF7E10AA499F320F* L_4 = __this->___parentRigid_19;
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_5;
		...
		Rigidbody2D_tBEBE9523CF4448544085AF46BF7E10AA499F320F* L_6 = __this->___parentRigid_19;
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_7;
		memset((&L_7), 0, sizeof(L_7));
		Vector2__ctor_m9525B79969AFFE3254B303A40997A56DEEB6F548_inline((&L_7), (0.0f), (-20.0f), /*hidden argument*/NULL);
		NullCheck(L_6);
...
IL_0063:
	{
		...
		PlayerController_SheldToX_m1A6A391EC5E8B9B2F9F0F1EAE4300637FFE49BBA(__this, NULL);
		// anime.ResetTrigger("offSheld");
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_8 = __this->___anime_14;
		NullCheck(L_8);
		Animator_ResetTrigger_m8DCA67D5A6B56702E3FAD4E18243E194B71297CC(L_8, _stringLiteral7C87C6BD2EEF5465D17899D0B16CCC43594E97DD, NULL);
		// }
		return;
	}
}
