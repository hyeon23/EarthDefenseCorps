...
-본 프로젝트는 건국대학교 **드림학기제(자기설계 학기제)** 를 통해  진행한 프로젝트입니다.
...
### 1. 게임 방법
<img width="100%" alt="Waggles" src="https://github.com/hyeon23/hyeon23/assets/77566434/ad8de1c2-af2b-46dd-8ad3-0acd6c47c369">

-탭을 통해 Finish Line 위에서 **딩글** 을 소환합니다.

-동일한 종류의 와글 2개가 충돌할 경우, 상위 와글로 진화합니다.

-상위 딩글을 조합할 수록 2의 제곱 수의 점수를 획득합니다. (딩글 = 1, 멈블 = 2...)
